				...
				<table>
					...
					<tr>
						...
						<td><input type="text" maxlength="60" size="60" name="txtNome"
							value="<%=aluno.getNomeAluno()%>" /></td>
					</tr>
					<tr>
						<td>E-mail:</td>
						<td><input type="text" maxlength="60" size="60"
							name="txtEmail" value="<%=aluno.getEmailAluno()%>" /></td>
					</tr>
					<tr>
						<td>Nascimento (dd/mm/aaaa):</td>
						<td><input type="text" maxlength="60" size="60" name="txtData"
							value="<%=data.format(aluno.getDtaNasc())%>" /></td>
					</tr>
					<tr>
						<td>Endereço:</td>
						<td><input type="text" maxlength="60" size="60"
							name="txtEndereco" value="<%=aluno.getEndAluno()%>" /></td>
					</tr>
					<tr>
						<td>Idade:</td>
						<td><input type="text" maxlength="60" size="60"
							name="txtIdade" value="<%=aluno.getIdadeAluno()%>" /></td>
					</tr>
					<tr>
